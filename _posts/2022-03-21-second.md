...
# ...so keycaps
  ...
  * Patience is vitrue after all
  ...
  Nowadays, the extra sets, those that havent been sold, are kinda easy to obtain, if you have the money at the time each vendor releases it. You can't know when though, if you are not _plugged_.

# Cases

  Simple (kinda) things here, most of those are aluminium, some others plastic. Designs are the ones that make the difference here, and make a designer famous, or not.

  There are lots out there, I would talk one line or two about the Matrix boaards. If I can. How to say this. They are out of this world. The ideas, the quality, everything. I ll probably make a full post about MatrixLabs. Its a pity to make a subpost here.

# This post is already long...

  ... and you probably know already all the rest, maybe not in detail, but you know, youtube is your friend. I will not try to keep this _noob_ friendly anyways.

## Until the next time... (maybe I ll be updating this post every now and then, V1/V2/etc)
